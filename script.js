document.addEventListener('DOMContentLoaded', () => {
    ...
    const RAZORPAY_KEY_ID = 'rzp_live_SpZ4mZhtHjMIYN';
    ...
    function processPayment(amount, description, customerName, customerMobile, customerEmail) {
        const options = {
            ...
            currency: 'INR',
            name: 'DigiTopup Services Enterprises Ltd',
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Thank you for your message! DigiTopup Services Enterprises Ltd will get back to you soon.');
            contactForm.reset();
        });
    }
